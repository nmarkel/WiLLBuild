...
def build_assembly(catalog: dict, cfg: PoleConfig) -> BuiltAssembly:
    ...
    # Phase 0.10.5: the part-number engine that resolved a configured design code
    # (e.g. "SS3" for a 3-arm cluster) is deliberately NOT ported here — the
    # frontend's buildPartNumber is the single source now (see spec D2). Real-CAD
    # resolution below therefore always falls back to each part's BASE file.
